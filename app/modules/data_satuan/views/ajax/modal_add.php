    ...
    <div class="modal-body">
        ...
        <form id="form_add">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="s_satuan" placeholder="Silahkan Masukan Nama Satuan">
            </div>
            <div class="form-group">
                <label>Keterangan</label>
                <input type="text" class="form-control" name="nama_satuan" placeholder="Silahkan Masukan keterangan">
            </div>
            <!-- END KONTEN -->
        </form>
        <!-- END FORM -->
